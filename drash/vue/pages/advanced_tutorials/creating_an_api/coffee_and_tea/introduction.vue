...
export default {
  data() {
    return {
      uri: this.$conf.drash.base_url + "/#/advanced-tutorials/creating-an-api/coffee-and-tea"
    };
  }
}
</script>
  ...
  div.row
    div.col
      ...
      p.text-center(style="margin-bottom: 0")
        a.btn.btn-success(:href="$conf.drash.base_url + '/#/advanced-tutorials/creating-an-api/coffee-and-tea/part-1'") Get Started
  div.row
    div.col
      hr
      h2-hash End State
