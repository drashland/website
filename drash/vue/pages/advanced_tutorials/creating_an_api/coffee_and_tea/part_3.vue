      ...
      ol
        li
          ...
          p
            code-block-slotted(language="typescript")
              template(v-slot:title) {{ example_code.coffee_resource.filepath }}
              template(v-slot:code) {{ example_code.coffee_resource.contents }}
        ...
        li
          p Create your tea resource file.
            code-block-slotted(language="typescript")
              template(v-slot:title) {{ example_code.tea_resource.filepath }}
              template(v-slot:code) {{ example_code.tea_resource.contents }}
