...
export const resource = {
    paths: ["/advanced-tutorials/creating-a-client-side-rendered-app-react/part-2"],
    meta: {
      title,
      subtitle,
    }
...
export default {
  data() {
    return {
      ...
      base_uri: baseUri,
      example_code: this.$example_code['drash/example_code/advanced_tutorials/creating_a_react_app/deno_tweets/part_2'],
      toc: [
...
page(
  ...
  breadcrumbs(:base_url="base_url + base_uri" :part="2" :parts="5")
  hr
