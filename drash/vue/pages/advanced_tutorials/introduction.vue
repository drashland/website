...
page
    div.row
        div.col
            ...
            ul
              ...
              li Requests
              li Servers
            p Understanding the above tutorials is crucial to understanding all the moving parts in the advanced tutorials. Please make sure you understand the above tutorials before moving on to an advanced tutorial.
    ...
    div.row
        div.col
            ...
            p All tutorials have example code blocks that work if copied and pasted. This is for your convenience. Also, almost all code blocks in the tutorials can be found in the repository <a href="https://github.com/drashland/deno-drash-docs/tree/master/docs/src/example_code" target="_BLANK">here</a>.
</template>
