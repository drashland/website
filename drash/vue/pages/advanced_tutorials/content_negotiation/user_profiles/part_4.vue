  ...
  div.row
    div.col
      ...
      div.jumbotron
        ...
        p There are many ways to handle the <code>Accept</code> header in Drash. We will go over one way in this tutorial part. Other ways to handle the <code>Accept</code> header can be found <a href="/#/tutorials/misc/content-negotiation">here</a>.
