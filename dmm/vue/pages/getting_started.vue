...
div
  ...
  div
    ...
    ol
      ...
      li
        ...
        code-block(title="Terminal" language="text")
          | deno run ---allow-read='.' --allow-write='deps.ts' --allow-net='cdn.deno.land,api.deno.land' https://deno.land/x/dmm@v1.1.3/mod.ts update
          |
          | Gathering facts...
    ...
    code-block(title="Terminal" language="text")
      | deno install --allow-read='.' --allow-write='deps.ts' --allow-net='cdn.deno.land,api.deno.land' https://deno.land/x/dmm@v1.1.3/mod.ts
      | dmm --help
    p This will make running commands easier &mdash; allowing you to type <code>dmm</code> instead of <code>deno run --allow-read='.' --allow-write='deps.ts' --allow-net='cdn.deno.land,api.deno.land' https://deno.land/x/dmm@v1.1.3/mod.ts</code>.
    hr
    h2-hash Features
    ul
      li
