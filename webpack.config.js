...
module.exports = envVars => {
  ...
  const configs = {
    ...
    sinco: Object.assign(repoConfigs.sinco, {
      base_url: getBaseUrl("sinco", envVars.enviromennt)
    })
  };
  ...
  return {
    entry: {
      ...
      sinco_app: path.resolve(__dirname, "sinco/assets/js/_app.js")
    },
    ...
    resolve: {
      alias: {
        ...
        "/sinco": path.resolve(__dirname, "sinco")
      }
    }
  };
};
