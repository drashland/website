...
page(
  ...
  ol
    ...
    li
      ...
      p
        img(:src="'/assets/drash-v1.x/img/example_code/advanced_tutorials/creating_a_static_html_app/about_me/1.png'")
    li
      p Go to <code>localhost:1447/contact</code> in your browser.
      p You should receive a response similar to the following:
      p
        img(:src="'/assets/drash-v1.x/img/example_code/advanced_tutorials/creating_a_static_html_app/about_me/2.png'")
    li
      p Go to <code>localhost:1447/about</code> in your browser.
      p You should receive a response similar to the following:
      p
        img(:src="'/assets/drash-v1.x/img/example_code/advanced_tutorials/creating_a_static_html_app/about_me/3.png'")
