...
page(
  ...
  p dmm will automatically run a sweep of checks on the repository's dependencies daily and create a pull request if updates are found.
  p Of course, if there are no dependencies to update, Dmm will not change any files. If no files are modified, then a pull request will not be made, and there are no changes to commit.
  p Here are some screenshots for a pull request being opened in on of our repositories:
  hr
  img(src="/assets/dmm-v1.x/img/bumper_pr_overview.png")
  hr
  img(src="/assets/dmm-v1.x/img/bumper_pr_files_changed.png")
</template>
