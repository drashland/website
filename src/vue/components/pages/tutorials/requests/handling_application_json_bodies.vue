...
export const resource = {
  ...
  meta: {
    title: "Handling application/json Bodies",
...
export default {
  data() {
    return {
      example_code: this.$app_data.example_code['/src/example_code/tutorials/requests/handling_application_json_bodies'],
      toc: {
        items: [
        ...
        li
          ...
          p You should receive the following response:
            code-block-slotted(:header="false")
              template(v-slot:code)
                | You passsed in the following body param: denosaurus
        li
