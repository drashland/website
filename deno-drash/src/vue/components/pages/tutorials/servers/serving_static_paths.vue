    ...
    div.col
      ...
      ol
        ...
        li Make a request in your browser.
          ...
          a(href="/deno-drash-docs/public/assets/deno-drash/img/example_code/tutorials/serving_static_paths/verification_1.png")
            img(:src="$conf.base_url + '/public/assets/deno-drash/img/example_code/tutorials/serving_static_paths/verification_1.png'")
</template>
