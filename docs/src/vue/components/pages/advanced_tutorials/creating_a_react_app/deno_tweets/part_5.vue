...
export const resource = {
    paths: ["/advanced-tutorials/creating-a-react-app/deno-tweets/part-5"],
    meta: {
      title: "Creating A React App",
      subtitle: "Part 5: Creating the React Components",
      source_code_uri: "/advanced_tutorials/creating_a_react_app/deno_tweets/part_5"
    }
}
...
export default {
  data() {
    return {
      ...
      example_code_components: this.$app_data.example_code['/src/example_code' + resource.meta.source_code_uri + '/components'],
      part: 5,
      parts: 5,
      toc: {
        items: [
...
page-tutorial-part(
  ...
  div.row
    div.col
      ...
      p Now you have everything setup, such as Webpack and your Drash server, you can start writing your React components in TSX.
      p-view-source-code
  div.row
    div.col
      hr
    ...
    div.col
      ...
      ol
        li Build your environment.
          ...
          p Now you have created your components, Webpack will transpile them so the browser can understand the contents
