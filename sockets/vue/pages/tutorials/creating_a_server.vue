...
page(
  ...
  p Servers require at least one channel in order to send and receive messages. In this tutorial, you will create a very basic server that can handle one channel.
  ...
  ol
    li
      ...
      code-block(title="/path/to/your/project/app.ts" language="typescript")
        ...
        | );
    li
      p Create a channel (see the highlighted code).
    ...
    li
      p Add a handler for your new channel (see the highlighted code).
      code-block(title="/path/to/your/project/app.ts" language="typescript" line_highlight="19-27")
        | import {
        |   IPacket,
        |   SocketServer,
        | } from "https://deno.land/x/sockets@v0.x/mod.ts";
  ...
  ol
    ...
    li
      ...
      p You should receive the following response:
      code-block(:header="false" language="text")
        | < {"from":"Server","to":"Channel 1","message":"Message received from 4: This is a test message."}
</template>
